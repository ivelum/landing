...
![Does your system handle any sensitive data?](sensitive-data.png)

![Which compliance standards could be relevant for your app?](compliance-standards.png)
...
![Who owns security on your team?](who-owns-security.png)

Only about a third of respondents said they currently have junior positions
on the team:

![Do you currently have junior engineering positions on your team?](junior-positions.png)
...
![How do you use AI in software development?](how-do-you-use-ai.png)

The distribution of AI-generated code in production is fairly even, ranging
from under 25% all the way up to 100%:

![Which percentage of your production code is written with AI?](production-code-written-with-ai.png)
...
![Do you think AI use poses any additional security risk to your team?](ai-additional-risk.png)
...
![What are your biggest concerns related to AI usage?](biggest-ai-concerns.png)
...
![Do you think your production code contains vulnerabilities?](production-code-vulnerabilities.png)

42% of respondents said they experienced a security incident:

![Have you ever experienced a security incident?](security-incident.png)

18% of respondents reported experiencing a supply chain attack, roughly half
of them within the past six months:

![Have your team ever been impacted by a supply chain attack?](supply-chain-attack.png)
...
![How do you mitigate potential vulnerabilities in your production code?](vulnerabilities-mitigation.png)

97% of respondents review AI-generated code the same as human-written code or
more strictly:

![Do you review AI-generated code differently from human-written code?](do-you-review-ai-code-differently.png)
